...
class MultiThreadRespond implements Runnable{
    ...
    private static String [] movies ={"Twilight","Batman","Titanic","Harry Potter","Frozen","	Minions","Skyfall","	Zootopia","Jurassic World","Black Panther","Avatar","Aquaman","Intolerance","Cleopatra","Mickey","Wings","Cavalcade","Bambi ","Cinderella","Psycho"         };
